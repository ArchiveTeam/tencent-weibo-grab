...
LUA_SHA1 = get_hash(os.path.join(CWD, 'tencent-weibo.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'tencent-weibo-dld-script-version: ' + VERSION,
        ...
        if item_type == 'user':
            wget_args.extend(['--warc-header', 'tencent-weibo-user: ' + item_value])
            wget_args.append('http://t.qq.com/' + item_value)
        else:
...
project = Project(
    title = '腾讯微博',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://archiveteam.org/images/2/28/Tencent-Weibo-logo.png" height="50px"/>
    <h2>t.qq.com <span class="links"><a href="http://t.qq.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/tencent-weibo/">Leaderboard</a></span></h2>
    '''
)
